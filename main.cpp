...
int main() {
    ...
    vehiclesArray[6] = new Jet("Delta", "Airbus", "Rocket", 3);
    vehiclesArray[7] = new Jet();
    vehiclesArray[8] = new Skateboard("Zero", "0n1yTh3B3ST");
    vehiclesArray[9] = new Skateboard("Element", "unknown");
    vehiclesArray[10] = new HotAirBalloon();
    vehiclesArray[11] = new HotAirBalloon("Brisbane", "Rainbow", "propane", 110);
